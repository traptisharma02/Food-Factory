  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    if(session.getAttribute("contact")==null)
    {
     ...
     Connection con=DBConnection.getConnection();
      ...
      out.write('\n');
             ...
             try{
                  String contact= request.getParameter("cont");
                    PreparedStatement ps=con.prepareStatement("select latitude,longtitude from user where user.contact_no='"+contact+"'");
      ...
      out.write("                <h2 style=\"margin-top: -1%;\">View customers <h3>whose payment is recieved</h3></h2>\n");
      out.write("                \n");
      out.write("                 </div>\n");
      out.write("              <button onclick=\"window.scrollTo(0, 0); \" id=\"myBtn\" title=\"Go to top\" ><i class=\"ion-arrow-up-c\"></i></button>\n");
      out.write("    <div class=\"container\">\n");
      out.write("       \n");
      out.write("                 <iframe width=\"100%\" height=\"500\" src=\"https://maps.google.com/maps?q=indore&output=embed\"></iframe>\n");
      out.write("               <iframe width=\"100%\" height=\"500\" src=\"https://maps.google.com/maps?q=");
      out.print(rs.getFloat("latitude"));
      out.write(',');
      out.print(rs.getFloat("longtitude"));
