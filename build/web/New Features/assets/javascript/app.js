...
function closeNav() {
  ...
  firebase.initializeApp(config);
    ...
    var dairyIngredients = ["butter", "milk",  "sour cream", "cream cheese", "corn", "yogurt", "cream", "evaporated milk", "whipped cream", "half and half"]
...
$(document).ready(function () {
    ...
    var searchIDs;
    var searchTerms = "butter"; //default search term
    var from = 0;
    var to = 12;
...
var ingredients = [
    "Banana", "Berries", "Pasta", "Mushroom", "Chups", "Tofu",
    "cornflour"
];
