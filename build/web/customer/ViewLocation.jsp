 ...
 <div class="limiter" >
     <div  class="container-login"  >
          ...
          <div class="text-center">
               <div class="container">
                <h2>View <%=rs.getString("name")%>'s location</h2>
                
                 </div>
              <button onclick="window.scrollTo(0, 0); " id="myBtn" title="Go to top" ><i class="ion-arrow-up-c"></i></button>
    <div class="container">
                 <iframe width="100%" height="400" src="https://maps.google.com/maps?q=<%=rs.getFloat("latitude")%>,<%=rs.getFloat("longtitude")%>&output=embed"></iframe>
                </div></div></div></div>
          <%
                        }
                        con.close();
